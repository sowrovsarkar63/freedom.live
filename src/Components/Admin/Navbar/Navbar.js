      ...
      <header className="py-6 bg-white shadow-sm">
        <nav className="flex flex-col  space-y-5 space-x-5  md:flex-row md:justify-around lg:flex-row lg:justify-around xl:flex-row xl:justify-around 2xl:flex-row 2xl:justify-around ">
          ...
          <div className="relative ">
            <button className="py-3 px-10 bg-[#F6F8FA] text-[#B5BAC7]   rounded-full shadow-md  focus:outline-none focus:ring-2  focus:ring-opacity-75   ">
              REFUGEE
            </button>
            <button className="py-3 px-10 bg-[#2488FF] text-white  rounded-full shadow-md  focus:outline-none focus:ring-2  focus:ring-opacity-75 absolute left-20 ml-5">
              OFFER
            </button>
          </div>
